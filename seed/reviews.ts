...
export const review : Review[] = [
  {
    movieId: 299054,
    reviewerName: "James781",
    rating: 6,
    content: "Although the film has its share of high points, there are more misses than hits, resulting in a 2 ½ hour experience that provokes frustration at a missed opportunity.",
  ...
  },
  {
    ...
    reviewerName: "ned3",
    rating: 5,
    content: "Better than their last effort.",
    reviewDate: "2022-09-03",
  },
  {
    movieId: 385687,
    reviewerName: "Proma6",
    rating: 8,
    content: "Most importantly, Scott Pilgrim Takes Off is true to its predecessors with an inexhaustibly fun spirit... The buoyant, punk rock, experimental soul of the story is thriving.",
